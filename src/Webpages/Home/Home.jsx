...
const slides = [
  ...
  },
  {
    ...
    description:
      "Madharaasi is a 2025 Indian Tamil-language psychological action thriller film written and directed by A. R. Murugadoss. Produced by Sri Lakshmi Movies, the film stars Sivakarthikeyan, Rukmini Vasanth, Vidyut Jammwal, Biju Menon, Vikranth and Shabeer Kallarakkal in the lead roles.",
    rating: "8.5/10",
    duration: "2hr 40min",
    certificate: "U/A",
                      ...
                      {group.map((movieposter) => (
                        <Col key={movieposter.id} sm={6} md={4} lg={2}>
                          <div
                            ...
                            style={{ height: "250px", cursor: "pointer" }}
                            onMouseEnter={() =>
                              setHoveredShowId(movieposter.id)
                            }
                          ...
                          >
                            ...
                            <div
                              ...
                              style={{
                                opacity:
                                  hoveredShowId === movieposter.id ? 1 : 0,
                                transition: "opacity 0.3s ease-in-out",
                              }}
                            >
                              <button
